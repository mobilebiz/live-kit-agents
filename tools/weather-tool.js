...
/**
 * Weather tool for getting weather information from OpenWeatherMap API
 */
export const weatherTool = llm.tool({
  description: "Get the weather for a location in Japan",
  parameters: {
    type: "object",
    properties: {
      location: {
        type: "string",
        description: "The location to get the weather for (e.g., '東京都', '大阪', '北海道')",
      },
    },
    required: ["location"],
  },
